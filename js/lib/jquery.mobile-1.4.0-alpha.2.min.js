...
$( document ).on( "pagebeforecreate", function( e, date ) {
  ...
  var footerSource = $("#template-footer" + hires).html();
  if (footerSource) {
  ...
  if (window.devicePixelRatio >= 2) {
    $("div[data-role='panel'] img").each( function( index ) {
      $( this )[0].src = "img/appendto-2x.png";
    });

    $("img.appendto-hires").each( function( index ) {
      $( this )[0].src = "img/sponsors/appendto-logo-2x.png";
    });
  }
